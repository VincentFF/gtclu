sf = "/home/doors/Code/dataset/origin/20k-20d-20c-0.6"
df = "/home/doors/Code/dataset/efficiency/20k-20d-20c-0.6"
...
#        for j in range(d):
#            sd[i][j] = (sd[i][j] - min_max[j][0]) / (min_max[j][1] - min_max[j][0])
